...
It was observed that both methods suffer from indifference concerning flipped letters if no synthetic data was used. However the method of Haider et al. tent to prdouce this mistake even with the synthetic data.  
