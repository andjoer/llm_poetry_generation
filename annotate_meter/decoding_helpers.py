...
class Teacher:
    ...
    def __call__(self, decoder, encoder_out, encoder_hidden):
        ...
        return outputs, masks.permute(1, 2, 0),1,1  # batch, src, trg
...
class Greedy:
    ...
    def __call__(self, decoder, encoder_out, encoder_hidden):
        ...
        return outputs, masks.permute(1, 2, 0), 1, 1 # batch, trg, src (i, x, y)


class Greedy_vectors:
    def __init__(self, maxlen=20, sos_index=2, use_stop=False):
        self.maxlen = maxlen
        self.sos_index = sos_index
        self.use_stop = use_stop
    ...
    def __call__(self, decoder, encoder_out, encoder_hidden):
        ...
        masks = torch.zeros(self.maxlen, batch_size, seq1_len)
        decoder_hidden = encoder_hidden[-decoder.n_layers:]  # take what we need from encoder
        encoder_hidden_final = encoder_hidden[-decoder.n_layers:]
        ...
        return outputs, masks.permute(1, 2, 0), encoder_hidden_final, encoder_out