...
def parse_arguments():
    ...
    parser.add_argument("--failed_rhyme_count_limit", type=int,default=4,help="number of alternative verses is created if no rhyme is found when force_rhyme is enabled")
